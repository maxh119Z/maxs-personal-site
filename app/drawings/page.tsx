...
export default function drawingsPage(){
    ...
    return (
        <div className="flex flex-col flex-1 items-center text-black bg-white font-sans">
            ...
            <section className="w-2/3 flex flex-col gap-32 mb-5">
                <div id = "artwork" className="scroll-mt-[15vh] flex items-center gap-8">
                    <h2 className="text-4xl font-light w-1/6 flex-col flex shrink-0">
                    ...
                    <div className="flex-1 flex flex-wrap items-end gap-3">
                        <GalleryImg src="drawing/art_1.png" alt="art 1" className="h-60 w-auto object-contain" />
                        <GalleryImg src="drawing/art_yosemite.png" alt="yosemite" className="h-52 w-auto object-contain" />
                        <GalleryImg src="drawing/art_2.png" alt="art 2" className="h-64 w-auto object-contain" />
                        <GalleryImg src="drawing/long_good.jpg" alt="long good" className="h-48 w-auto object-contain" />
                       
                    </div>
                </div>

                <div id = "people" className="scroll-mt-[15vh] flex items-center gap-8">
                    <div className="flex-1 flex flex-wrap items-end gap-3">
                        <GalleryImg src="drawing/people_overview.png" alt="people overview" className="h-52 w-auto object-contain" />
                        <GalleryImg src="drawing/people.png" alt="people" className="h-64 w-auto object-contain" />
                        <GalleryImg src="drawing/npeople.jpg" alt="npeople" className="h-56 w-auto object-contain" />
                        <GalleryImg src="drawing/person2.jpg" alt="person 2" className="h-60 w-auto object-contain" />
                        <GalleryImg src="drawing/eye_good.jpg" alt="eye good" className="h-56 w-auto object-contain" />
                    </div>
                    <h2 className="text-4xl font-light w-1/6 flex-col flex shrink-0">
                ...
                <div id = "other" className="scroll-mt-[15vh] flex items-center gap-8">
                    <h2 className="text-4xl font-light w-1/6 flex-col flex shrink-0">
                        <a href="#artwork"  className="opacity-[0.5] !text-2xl">artwork</a>
                        <a href="#people" className="opacity-[0.5] !text-2xl">people</a>
                    ...
                    <div className="flex-1 flex flex-wrap items-end gap-3">
                        <GalleryImg src="drawing/other.png" alt="other" className="h-64 w-auto object-contain" />
                        <GalleryImg src="drawing/other1.jpg" alt="other 1" className="h-52 w-auto object-contain" />
                        <GalleryImg src="drawing/other2.jpg" alt="other 2" className="h-60 w-auto object-contain" />
                        <GalleryImg src="drawing/other3.jpg" alt="other 3" className="h-56 w-auto object-contain" />
                    </div>
                </div>

                <div id = "ipad" className="scroll-mt-[15vh] flex text-center align-center items-center gap-8">
                    <div className="flex-1 flex flex-wrap items-end gap-3">
                        <GalleryImg src="drawing/ipad2.png" alt="ipad 2" className="h-56 w-auto object-contain" />
                        <GalleryImg src="drawing/ipad_weekend.png" alt="ipad weekend" className="h-48 w-auto object-contain" />
                        <GalleryImg src="drawing/ipad1.jpg" alt="ipad 1" className="h-64 w-auto object-contain" />
                        <GalleryImg src="drawing/ipad3.jpg" alt="ipad 3" className="h-60 w-auto object-contain" />
                        <GalleryImg src="drawing/faces.png" alt="faces" className="h-52 w-auto object-contain" />
                    </div>
                    <h2 className="text-4xl font-light w-1/6 flex-col flex shrink-0">
                        <a href="#artwork"  className="opacity-[0.5] !text-2xl">artwork</a>
                        <a href="#people" className="opacity-[0.5] !text-2xl">people</a>
